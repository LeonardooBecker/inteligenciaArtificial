...
void verificaMapa(Verificar **mapa, int i, int j, Parametros param, int *casas, int **matValoracao)
{
    Verificar *direita;
    Verificar *baixo;
    Verificar *cima;
    ...
    */
    if ((j < (param.num_linhas - 1)) && (direita->verificar == 1) && (direita->valor != atual->valor) && (atual->camadaExterna == 0))
    {
        ...
        verificaMapa(mapa, i, (j + 1), param, casas, matValoracao);
    }
    ...
    */
    if ((i < (param.num_colunas - 1) && (baixo->verificar == 1) && (baixo->valor != atual->valor)) && (atual->camadaExterna == 0))
    {
        ...
        verificaMapa(mapa, (i + 1), j, param, casas, matValoracao);
    }
...
void progride(Verificar **mapa, int row, int column, int **matrizValoracao, Parametros param, int count, int *vetorSolucao, int *vetorAtual, int qntVerificacoes)
{
    ...
    verificaMapa(mapa, row, column, param, &casas, matrizValoracao);
    ...
    while (1)
    {
        ...
        verificaMapa(mapaAqui, row, column, param, &casas, matrizValoracao);
